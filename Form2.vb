...
Public Class Form2
    ...
    Private Sub Btn_aceptar_Click(sender As Object, e As EventArgs) Handles Btn_aceptar.Click
        ...
        '
        My.Forms.Form1.Txt_PVrngSup.Text = Txt_rangomax.Text.Trim
        My.Forms.Form1.Txt_PVrngInf.Text = Txt_rangomin.Text.Trim
        Me.Hide()
    End Sub
    ...
    Private Sub Btn_calcular_Click(sender As Object, e As EventArgs) Handles Btn_calcular.Click
        Try
            ...
            Dim rango As Single = Math.Abs(CSng(Txt_rangomax.Text.Trim) - Txt_rangomin.Text.Trim)
            ...
            Txt_K.Text = ((100 * dPV / rango) / dOP).ToString("#####0.000")
            Txt_Tp.Text = (1.5 * (dataPointT2.XValue - dataPointT1.XValue)).ToString("####0.00")
